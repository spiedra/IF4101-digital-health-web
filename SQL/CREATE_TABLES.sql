...
CREATE TABLE PATIENT.tb_PHONE_NUMBERS(
PHONE_NUMBERS_ID INT IDENTITY(1,1) PRIMARY KEY NOT NULL,
PHONE_NUMBER_1 VARCHAR(32) NOT NULL,
PHONE_NUMBER_2 VARCHAR(32) NULL,
IS_DELETED BIT DEFAULT 0 NULL
);
...
CONSTRAINT fk_patient_phone_numbers FOREIGN KEY (PHONE_NUMBERS_ID) REFERENCES PATIENT.tb_PHONE_NUMBERS(PHONE_NUMBERS_ID)
);
...
--CREATE TABLE PATIENT.tb_PHONE_PATIENT ** NO SE ESTA UTILIZANDO
--(
--PATIENT_ID INT NOT NULL,
