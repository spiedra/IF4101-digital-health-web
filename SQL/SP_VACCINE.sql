...
BEGIN
	...
	ELSE
		BEGIN
			...
			IF EXISTS (SELECT PATIENT_ID, VACCINE_ID FROM PATIENT.tb_VACCINE_PATIENT WHERE PATIENT_ID=@local_patient_id AND VACCINE_ID=@local_vaccine_id)
				BEGIN
					RETURN 0;
				END
			ELSE
